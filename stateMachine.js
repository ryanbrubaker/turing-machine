...
(function() {
  ...
  Turing.StateMachine = (function() {
    ...
    StateMachine.prototype.setup = function(states) {
      var character, currentStateName, i, initialStateName, newState, operations, state, stateName, stateNames, _i, _j, _len, _ref, _ref1, _ref2;
      this.states = {};
      ...
      for (stateName in _ref1) {
        ...
        if (__indexOf.call(stateNames, stateName) >= 0) {
