...
(function() {
  var State, StateMachine, Tape, alternatingOnesAndZeros, currentOperations, drawCurrentTapeSnapshot, drawThickLine, init, machineTimer, nextOperation, oneFourth, sequencesOfOnes, shiftHeadLeft, shiftHeadRight, shiftTapeStep, shiftTimer, stateMachine, tape;

  alternatingOnesAndZeros = [['a', 'none', 'P0', 'a'], ['', '0', 'R, R, P1', 'a'], ['', '1', 'R, R, P0', 'a']];

  oneFourth = [['a', 'none', 'P0, R', 'b'], ['b', 'none', 'R', 'c'], ['c', 'none', 'P1, R', 'd'], ['d', 'none', 'R', 'e'], ['e', 'none', 'P0, R', 'd']];

  sequencesOfOnes = [['a', 'any', 'P@, R, P@, R, P0, R, R, P0, L, L', 'b'], ['b', '1', 'R, Px, L, L, L', 'b'], ['', '0', '', 'c'], ['c', 'any', 'R, R', 'c'], ['', 'none', 'P1, L', 'd'], ['d', 'x', 'E, R', 'c'], ['', '@', 'R', 'e'], ['', 'none', 'L, L', 'd'], ['e', 'any', 'R, R', 'e'], ['', 'none', 'P0, L, L', 'b']];
  ...
  init = function() {
    ...
    $(function() {
      return $('#one-fourth-machine').on('click', function() {
        ...
        clearTable();
        _results = [];
        for (_i = 0, _len = oneFourth.length; _i < _len; _i++) {
          rowValues = oneFourth[_i];
          newRow = addRowToTable();
          textFields = $(newRow).children('td').children('input');
          _results.push((function() {
            var _j, _ref, _results1;
    ...
    return $(function() {
      return $('#sequences-of-ones').on('click', function() {
        ...
        clearTable();
        _results = [];
        for (_i = 0, _len = sequencesOfOnes.length; _i < _len; _i++) {
          rowValues = sequencesOfOnes[_i];
          newRow = addRowToTable();
          textFields = $(newRow).children('td').children('input');
          _results.push((function() {
            var _j, _ref, _results1;
